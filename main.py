...
#main文
df = 'y_data.csv' # 加速度とトルクを含むcsvファイル
torque = csv2ndarray(df, 0) #トルク（csv0列目）
ddx = csv2ndarray(df, 3) #加速度（csv3列目）
func = regression(ddx, torque, 1)
graph(ddx, torque, linspace(ddx), func)
